 ...
 *my site:  http://htmlcssjs.duapp.com/
 *my blog: http://www.cnblogs.com/iamzhanglei/
 *my weibo: http://weibo.com/iamleizhang 
 *create by 当耐特
 * Date: 2013-6-20
 */
; (function (window) {
    var _promise = function (thens) {
        ...
        this._CONSTANT = { any: "any", number: "number", resolved: "resolved", rejected: "rejected",pending:"pending" };
    };
    ...
    _promise.prototype = {
        ...
        any: function (done, fail, progress) {
            this.thens.push({ done: done, fail: fail, progress: progress, action: this._CONSTANT.any });
            return this;
        },
        ...
        progress: function (progress) {
            ...
            if (this.thens.length === 0 || this.thens[this.thens.length - 1].finallyCB) {
                ...
                this.thens.push({ finallyCB: finallyCB });
            } else {
        ...
        always: function (alwaysCB, progress) {
            this.thens.push({ done: alwaysCB, fail: alwaysCB, progress: progress });
            return this;
        },
