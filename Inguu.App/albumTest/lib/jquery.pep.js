...
;(function ( $, window, undefined ) {
  ...
  var defaults   = {
    ...
    easing:                         null,
    rest:                           function(){},
    isBoxZoom:                      false,  //图片的父容器是否是缩放过的
    isTextZoom:                     false,  //文字层的父容器是否是缩放过的
    moveTo:                         false,
    ...
    var self = this;
            ...
            if ( this.isValidMoveEvent(ev) && !this.disabled ){
              ...
              if( !(this.options.ignoreRightClick && ev.which === 3) ) {
                    ...
                    this.$el.addClass('actived').siblings().removeClass('actived');
  ...
  Pep.prototype.handleMove = function() {
            ...
            //获取模板的zoom值
            if(this.options.isBoxZoom){
              var zoom = parseFloat(this.$el.parent().parent().css('zoom'))||1;            
              this.doMoveTo(dx/zoom, dy/zoom);
            }else if(this.options.isTextZoom){
              var zoom = parseFloat(this.$el.parent().css('zoom'))||1;            
              this.doMoveTo(dx/zoom, dy/zoom);
            }else{
              this.doMoveTo(dx, dy);
            }
  ...
  Pep.prototype.isOverlapping = function($a,$b) {
    ...
    var zoom = parseFloat($a.parent().css('zoom'))||1;

    return !( rect1.right*zoom   < rect2.left  ||
              rect1.left*zoom    > rect2.right ||
              rect1.bottom*zoom  < rect2.top   ||
              rect1.top*zoom    > rect2.bottom  );
  };
