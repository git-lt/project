	...
	**/
	Mobilebone.transition = function(pageInto, pageOut, back, options) {
		...
		var defaults = {
			...
			transitionBefore: this.transitionBefore,
			...
			["onpagefirstinto", "callback", "fallback", "animationstart", "animationend", 'transitionBefore', 'transitionEnd'].forEach(function(key) {
